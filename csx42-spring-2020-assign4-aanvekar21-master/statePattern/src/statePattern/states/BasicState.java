 ...
 */
public class BasicState implements ExpenditureStateI {
	 ...
	 * @param contextObj
	 */
	public BasicState(ExpenditureContextI contextObj) {
	...
	public void fetchListOfItems(String item) throws IOException {
		...
		if (itemCategory.equals("basic") && !itemCategory.isEmpty()) {

			System.out.println("BASIC::" + item + "--" + "YES");
			Results.getInstance().stateResults("BASIC::" + item + "--" + "YES");
		} else if (!itemCategory.isEmpty()) {

			System.out.println("BASIC::" + item + "--" + "NO");
			Results.getInstance().stateResults("BASIC::" + item + "--" + "NO");
		} 
